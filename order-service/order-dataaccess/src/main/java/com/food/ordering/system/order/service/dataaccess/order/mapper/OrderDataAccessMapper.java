...
public class OrderDataAccessMapper {
    ...
    public OrderEntity orderToOrderEntity(Order order) {
        OrderEntity orderEntity = OrderEntity.builder()
                ...
                .ordenStatus(order.getOrderStatus())
                ...
                .build();
        orderEntity.getAddress().setOrden(orderEntity);
        orderEntity.getItems().forEach(orderItemEntity -> orderItemEntity.setOrden(orderEntity));
        return orderEntity;
    }
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity) {
        return Order.builder()
                ...
                .orderStatus(orderEntity.getOrdenStatus())
